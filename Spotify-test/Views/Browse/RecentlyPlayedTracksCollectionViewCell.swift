//
//  RecentlyPlayedTracksCollectionViewCell.swift
//  Spotify-test
//
...
class RecentlyPlayedTracksCollectionViewCell: UICollectionViewCell {
    static let identifier = "RecentlyPlayedTracksCollectionViewCell"
...
//        artistNameLabel.backgroundColor = .systemIndigo
    ...
    func configure(withModel model: RecentPlayedTracksCellViewModel) {
